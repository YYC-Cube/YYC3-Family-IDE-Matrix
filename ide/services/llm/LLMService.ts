 ...
 * @migrated: 回迁自 archive/ide-monolith-2026-03/LLMService.ts（1.5 批能力域回迁 · 2026-08-20）
 */

import { logger } from "../logger";
import { BUILTIN_PROVIDERS, type ProviderDef } from "./providers";
import { getAIDegradationService } from "./AIDegradationService";
import type {
  ProviderId,
  ProviderConfig,
  ProviderModel,
...
// 共享类型已前移至 ./types，此处按原 API 出口 re-export（消费方路径不变）
export type {
  ProviderId,
  ProviderConfig,
  ProviderModel,
