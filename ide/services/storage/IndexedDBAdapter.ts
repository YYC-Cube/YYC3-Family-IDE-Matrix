 ...
 * @migrated: 回迁自 archive/ide-monolith-2026-03/adapters/IndexedDBAdapter.optimized.ts（第二批 · 2026-08-20） · 双版本合并：以 optimized 为基座，补回基础版被丢失的 getDB 导出（Backup/Versioning 依赖）
 */
