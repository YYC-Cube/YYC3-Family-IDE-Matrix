    ...
    <div className="size-full flex flex-col bg-[var(--ide-bg)]">
      ...
      <div className="flex-shrink-0 flex border-b border-[var(--ide-border-dim)]">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1 py-1.5 text-[0.68rem] transition-colors ${activeTab === "changes"
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1 py-1.5 text-[0.68rem] transition-colors ${activeTab === "log"
            ? "text-sky-400 border-b border-sky-500"
            : "text-slate-600 hover:text-slate-400"
            }`}
        >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="border-b border-[var(--ide-border-subtle)]">
            <div
              ...
              className="w-full flex items-center gap-1.5 px-3 py-1.5 hover:bg-white/3 transition-colors cursor-pointer"
              role="button"
              tabIndex={0}
              onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowStaged(!showStaged); } }}
            >
              {showStaged ? (
          ...
          <div>
            <div
              ...
              role="button"
              tabIndex={0}
              onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setShowUnstaged(!showUnstaged); } }}
            >
              {showUnstaged ? (
                <ChevronDown className="w-3 h-3 text-slate-600" />
              ) : (
