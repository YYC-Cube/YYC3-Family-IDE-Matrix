 ...
 * @migrated: 回迁自 archive/ide-monolith-2026-03/XTerminal.tsx（收官清理 · 2026-08-20）
 */
...
/** 终端写入句柄（onReady 回调交出，收官清理新增：TerminalPanel 消费） */
...
interface XTerminalProps {
  ...
  /** 实例就绪后交出写入句柄 */
  onReady?: (handle: XTerminalHandle) => void
  className?: string
...
export function XTerminal({
  ...
  useEffect(() => {
    ...
    onReady?.({
      ...
      writeln: (line: string) => term.writeln(line),
      clear: () => term.clear(),
      focus: () => term.focus(),
    })
