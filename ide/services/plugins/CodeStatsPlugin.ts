 ...
 * @migrated: 回迁自 archive/ide-monolith-2026-03/plugins/CodeStatsPlugin.ts（第二批 · 2026-08-20） · 移除 @ts-nocheck
 */
 ...
 * 显示代码统计信息
 */
function showStats(context: PluginAPI) {
 ...
 * 更新统计
 */
function updateStats(context: PluginAPI, path: string) {
