...
export const SK_HIDDEN_PROVIDERS = "yyc3-hidden-providers";     // 用户隐藏的内置服务商 ID 列表
export const SK_PROVIDER_MODEL_ADDITIONS = "yyc3-provider-model-additions"; // 给内置服务商添加的自定义模型
export const SK_PROVIDER_MODEL_REMOVALS = "yyc3-provider-model-removals"; // 从内置服务商移除的模型 ID 列表
export const SK_PROVIDER_EDITS = "yyc3-provider-edits";         // 内置服务商属性修改（名称等）
